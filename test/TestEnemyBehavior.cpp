...
protected:
    ...
    virtual void SetUp() {
        ...
        enemy = std::make_shared<Enemy>("Guard",sf::Vector2f(0,0), 50,5,sf::Vector2f(8.0f*64.0f,0),7.0f,sf::Vector2f(128.0f*2.0f,32.0f),"patrol");
...
//Test jump quando collide con un blocco (fight)
